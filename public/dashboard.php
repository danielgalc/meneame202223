                        ...
                        <tr>
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                ...
                                <form action="modificar.php" method="POST" class="inline">
                                    ...
                                    <button type="button" onclick="cambiar(event, <?= $fila['id'] ?>)" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" data-modal-toggle="modificar">Modificar</button>
                                </form>



                                <!-- <a href="modificar.php?id=<?= $fila['id'] ?>"><button class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" type="button" data-modal-toggle="modificar">Modificar</button></a>
                                </form> -->
                            </td>
                        </tr>
                    <?php endforeach ?>
