                    ...
                    <?php foreach ($sent as $fila) : ?>
                        <tr>
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                ...
                                <a href="modificar.php?=<?= $fila['id'] ?>"><button class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" type="button" data-modal-toggle="modificar">Modificar</button></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
